...
module.exports = {
  ...
  sponsorBanner: () => {
    ...
    const blurb = `FeaturePeak creates supercharged deployment |previews of your frontend that you can share with your team to quickly get feedback on |your implementation in progress. |${link}`;
